...
namespace WxAxW.PinAssistant.Core
{
    internal class PinGroupHandler : PluginComponent
    {
        ...
        {
            return InitializePinGroup(GetPinKey(newPin), newPin.m_name, newPin.m_type, pinColor);
        }
        ...
        private PinGroup InitializePinGroup(string key, string pinName, Minimap.PinType pinType, Color pinColor, bool forceChangeColor = false)
        {
        ...
        private void TransferPinGroup(string oldPinsName, string newPinsName, Minimap.PinType oldType, Minimap.PinType newType)
        {
            ...
            PinGroup pinGroupToMerge = InitializePinGroup(newPinsKey, newPinsName, newType, Color.white);
        ...
        private void OnTrackedObjectAdd(TrackedObject trackedObject)
        {
            ...
            InitializePinGroup(pinKey, pinName, pinType, pinColor, forceChangeColor: true);
        }
